...
(function() {
  var Autocomplete = function(opts) {
    ...
    // truncate dropdown
    this.truncateDropdown = this.element.getAttribute('data-truncate') && this.element.getAttribute('data-truncate') == 'on' ? true : false;
  ...
  function truncateAutocompleteList(element) {
    // log(element.truncateDropdown)
    // if(!element.truncateDropdown) return;
    // reset max height
    element.results.style.maxHeight = '300px;';
    element.results.style.scrollBehavior = 'auto';
    element.results.style.overflowY = 'scroll';
    element.results.style.backgroundColor = 'var(--color-bg)';
