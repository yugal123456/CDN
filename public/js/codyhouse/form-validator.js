...
(function() {
    ...
    function showError(formValidator, field) {
      ...
      console.log("show errorr", formValidator)
      console.log("show errorr field", field)
    ...
    function toggleErrorClasses(formValidator, field, bool) {
      ...
      if(formValidator.options.inputWrapperErrorClass) {
        ...
        if(wrapper) {
          console.log("toggle error wrapper", wrapper)
          console.log("toggle error class", formValidator.options.inputWrapperErrorClass)
        ...
        console.log("toggle error class", wrapper)
      }
    };
